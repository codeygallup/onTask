...
async function passwordRecover(to, recoveryToken) {
    ...
    const emailBody = `Follow the link to update your password: ${resetLink}. If you did not request a password reset, please ignore this email.`;
